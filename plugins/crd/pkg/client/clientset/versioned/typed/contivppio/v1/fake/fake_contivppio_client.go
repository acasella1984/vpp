...
import (
	v1 "github.com/contiv/vpp/plugins/crd/pkg/client/clientset/versioned/typed/contivppio/v1"
...
func (c *FakeContivppV1) NetworkFirewallProfiles(namespace string) v1.NetworkFirewallProfileInterface {
